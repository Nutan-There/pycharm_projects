...
Test Case 11: Verify Subscription in Cart Page
    ...
    # Test Step 4: Click 'Cart' button
    Click Element    xpath=//a[contains(text(), 'Cart')]

    # Test Step 5: Scroll down to footer
    Execute JavaScript    window.scrollTo(0, document.body.scrollHeight);

    # Test Step 6: Verify text 'SUBSCRIPTION'
    #Wait Until Page Contains    SUBSCRIPTION

    # Test Step 7: Enter email address in input and click arrow button
    Input Text    id=susbscribe_email   ${EMAIL}
    Click Element    id=subscribe

    # Test Step 8: Verify success message 'You have been successfully subscribed!' is visible
